...
import com.sgo.hpku.adapter.GridViewAdapter;
...
import com.sgo.hpku.fragments.ClosedTypePickerFragment;
import com.sgo.hpku.fragments.TimePickerFragment;
            ...
            if (InetHandler.isNetworkAvailable(getApplicationContext())) {
                ...
                if ( hasError == false ) {
                    try{
                        ...
                        MyApiClient.setupOpeningHour(BbsSetupOpenHourActivity.this, params, new JsonHttpResponseHandler() {
                            @Override
