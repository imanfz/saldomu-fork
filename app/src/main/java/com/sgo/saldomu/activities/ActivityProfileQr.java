...
//                                finish();
    ...
    private void getHelpList() {
        try {
            ...
            MyApiClient.getHelpList(ActivityProfileQr.this,params, new JsonHttpResponseHandler() {
                @Override
                ...
                private void failure(Throwable throwable){
                    if(MyApiClient.PROD_FAILURE_FLAG)
                        Toast.makeText(ActivityProfileQr.this, getString(R.string.network_connection_failure_toast), Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(ActivityProfileQr.this, throwable.toString(), Toast.LENGTH_SHORT).show();
