...
//                                String member_name = mArrayCommunity.getJSONObject(i).getString(WebParams.MEMBER_NAME);
                                ...
                                scadmCommunityModel.setComm_id("001");
                                scadmCommunityModel.setComm_code("EMO");
                                scadmCommunityModel.setComm_name("Saldomu");
                                scadmCommunityModel.setMember_code("M001");
                                scadmCommunityModel.setMember_name("Yessi");
