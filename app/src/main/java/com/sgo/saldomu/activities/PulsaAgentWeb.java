                    ...
                    new ResponseListener() {
                        ...
                        public void onResponses(JsonObject object) {
                            ...
                            if (code.equals(WebParams.SUCCESS_CODE)) {
                                ...
                                alertDialogUpdateApp.showDialogUpdate(PulsaAgentWeb.this, appModel.getType(), appModel.getPackageName(), appModel.getDownloadUrl());
                            } else if (code.equals(DefineValue.ERROR_0066)) {
                                Timber.d("isi response maintenance:" + object.toString());
                                AlertDialogMaintenance alertDialogMaintenance = AlertDialogMaintenance.getInstance();
                                alertDialogMaintenance.showDialogMaintenance(PulsaAgentWeb.this, model.getError_message());
                            }else {
                                if (code.equals("0003")) {
