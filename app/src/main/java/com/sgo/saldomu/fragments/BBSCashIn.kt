...
import kotlinx.android.synthetic.main.bbs_cash_in.*
...
class BBSCashIn : BaseFragment(), ConfirmationDialog.clickListener {
    ...
    private var bbsBankModel: BBSBankModel? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.bbs_cash_in, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (cashInHistoryModel != null) {
            ...
            no_tujuan_value.setText(cashInHistoryModel!!.benef_product_value_code)
        ...
        if (enabledAdditionalFee)
            et_additionalFee.visibility = View.VISIBLE
        else
            et_additionalFee.visibility = View.GONE
    ...
    private fun inputValidation(): Boolean {
        ...
        if (no_tujuan_value.text.isEmpty()) {
            no_tujuan_value.requestFocus()
            no_tujuan_value.error = getString(R.string.forgetpass_edittext_validation)
            return false
        }
