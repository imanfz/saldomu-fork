...
//        tokoEBDActivity.initializeToolbar(getString(R.string.purchase_order))
    ...
    private fun getDetail()
    {
        ...
        try {
            ...
            params[WebParams.CUST_TYPE] = "CANVASSER" // "TOKO"
            params[WebParams.DOC_NO] = obj!!.doc_no
            params[WebParams.DOC_DETAIL] = "[{\"reff_no\":\"\",\"mapping_items\":[{ \"item_name\":\"Sobat Kretek\",\"item_code\":\"SK\",\"price\":13000,\"unit\":\"Pack\",\"format_qty\":[{\"mapping_unit\":\"Bal\", \"mapping_qty\":0},{\"mapping_unit\":\"Slop\", \"mapping_qty\":0},{\"mapping_unit\":\"Pack\", \"mapping_qty\":1}]}]}]"
