            ...
            MyApiClient.sentInsertTransTopup(getActivity(),params, new JsonHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    try {
                        ...
                        Timber.d("isi response insertTrx Collection:" + response.toString());
                ...
                private void failure(Throwable throwable){
                    ...
                    btnSubmit.setEnabled(true);
                    Timber.w("Error Koneksi isrt transtopup collecDesc:"+throwable.toString());
                }
            });
        }catch (Exception e){
...
//                            Timber.w("max token sesudah", String.valueOf(max_token_resend));
                ...
                private void failure(Throwable throwable){
                    ...
                    btnSubmit.setEnabled(true);
                    Timber.w("Error Koneksi resend token collecDesc:"+throwable.toString());
                }
            };
        ...
        try{
            ...
            MyApiClient.sentGetTRXStatus(getActivity(),params, new JsonHttpResponseHandler() {
                    ...
                    try {
                        ...
                        if (code.equals(WebParams.SUCCESS_CODE) || code.equals("0003")) {
                            ...
                            showReportBillerDialog(sp.getString(DefineValue.USER_NAME, ""), DateTimeFormat.formatToID(response.optString(WebParams.CREATED, "")),
                                    ...
                                    response.optString(WebParams.TX_STATUS, ""), response.optString(WebParams.TX_REMARK, ""), _amount);
                        }
                        else if(code.equals(WebParams.LOGOUT_CODE)){
                            Timber.d("isi response autologout:"+response.toString());
                            String message = response.getString(WebParams.ERROR_MESSAGE);
                ...
                private void failure(Throwable throwable){
                    ...
                    btnSubmit.setEnabled(true);
                    Timber.w("Error Koneksi trx status collecDesc:"+throwable.toString());
                }
            });
        }catch (Exception e){
            Timber.d("httpclient:"+e.getMessage());
