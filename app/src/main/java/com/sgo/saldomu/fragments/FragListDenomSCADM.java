...
public class FragListDenomSCADM extends BaseFragment implements ListDenomSCADMAdapter.listener{
    ...
    public void getListCommunity() {
        try {
            ...
            RequestParams params = MyApiClient.getSignatureWithParams(commIDLogin, MyApiClient.LINK_GET_LIST_COMMUNITY_DENOM_SCADM,
            ...
            JsonHttpResponseHandler mHandler = new JsonHttpResponseHandler() {
                ...
                private void failure(Throwable throwable) {
                    ...
                    Timber.w("Error Koneksi get list community denom scadm:" + throwable.toString());
                }
            ...
            MyApiClient.setLinkGetListCommunityDenomSCADM(getActivity(), params, mHandler);
