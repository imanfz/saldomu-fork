...
public class FragRegisterSMSBanking extends BaseFragment {
    ...
    private void getBankList(){
        try{
            ...
            RequestParams param = MyApiClient.getSignatureWithParams(MyApiClient.COMM_ID,MyApiClient.LINK_LIST_BANK_SMS_REGIST,
    ...
    private void sentInquiryMobileJTM(final String _bank_name){
        try{
            ...
            RequestParams param = MyApiClient.getSignatureWithParams(MyApiClient.COMM_ID,MyApiClient.LINK_INQUIRY_MOBILE_JATIM,
    ...
    private void getDataSB() {
        try {
            ...
            RequestParams param = MyApiClient.getSignatureWithParams(MyApiClient.COMM_ID,MyApiClient.LINK_INQUIRY_MOBILE,
                    userPhoneID,accessKey);
