...
public class InputAmountTagihBillerIndomobilDialog extends DialogFragment {
    ...
    public static InputAmountTagihBillerIndomobilDialog newDialog(int pos, InvoiceDGI obj, String partialPayment, OnTap listener) {
        InputAmountTagihBillerIndomobilDialog dialog = new InputAmountTagihBillerIndomobilDialog();
    ...
    boolean checkInput(String input) {
        return Integer.parseInt(input) <= Integer.parseInt(obj.getRemain_amount()) + 1000 &&
