...
public class ReportAdditionalFeeAdapter extends ArrayAdapter<ReportDataModel> {
...
//    }
    ...
    public ReportAdditionalFeeAdapter(Context context, int resource, List<ReportDataModel> reportListModel) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            holder = new ReportAdditionalFeeAdapter.ListHolder();
...
//        ReportListCommFeeModel itemnya = data.get(position);
        ...
        holder.tv_type.setText(itemnya.getComm_name());
        holder.tv_desc.setText(itemnya.getStatus());
